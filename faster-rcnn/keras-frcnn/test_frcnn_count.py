...
parser.add_option("-d", "--input_dir", dest="input_dir", help="Path to input working directory.", default="/home/ubuntu/gehl-detect/204GOPRO")
parser.add_option("-u", "--output_dir", dest="output_dir", help="Path to output working directory.", default="/home/ubuntu/gehl-detect/output")
